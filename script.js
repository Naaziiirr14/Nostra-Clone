...
function renderHomepage() {
    ...
    // Most wanted – pick some with sale flag (we add sale manually)
    const mostWanted = products.filter((_, i) => i % 2 === 0).map(p => ({ ...p, sale: true }));
    renderGrid('mostWantedGrid', mostWanted, true);
}
